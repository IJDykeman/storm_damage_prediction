...
#
# random.seed(123)
# random.shuffle(train_keymaps)
# val_key_list = train_keymaps[:int(len(train_keymaps) * .2)]
#
# val_key_set = set(val_key_list)
#
# train_key_set = set(train_keymaps)
#
# train_key_set = train_key_set - val_key_set # remove validation keymaps from the test set
# assert len(train_key_set) + len(val_key_set) == len(train_keymaps)
#
#
# all_keymaps = set(meta['keymap'])
# assert len(all_keymaps) == len(train_keymaps) + len(test_keymaps)
# x = meta['lat']
# y = meta['lon']
# keymap_to_int = {}
# int_to_keymap = {}
